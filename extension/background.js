...
function init() {
  ...
  chrome.storage.local.get(
    ...
    (result) => {
      ...
      if (result.apiKey === undefined) updates.apiKey = DEFAULT_CONFIG.apiKey;
      if (result.isEnabled === undefined) updates.isEnabled = DEFAULT_CONFIG.isEnabled;
      if (result.disabledSites === undefined) updates.disabledSites = DEFAULT_CONFIG.disabledSites;
      if (result.suggestionDelay === undefined) updates.suggestionDelay = DEFAULT_CONFIG.suggestionDelay;
      if (result.presentationMode === undefined) updates.presentationMode = DEFAULT_CONFIG.presentationMode;
