...
-   **3.1. In Scope:**
    ...
    -   Secure handling of user's API key: Stored in `chrome.storage.local`, sent securely (HTTPS) to the backend _only_ when needed for a request, **never stored on the backend**.
